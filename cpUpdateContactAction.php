...
$cpID = mysqli_real_escape_string($dbc, trim($_POST['cpID']));
$contactNo = mysqli_real_escape_string($dbc, trim($_POST['contactNo']));
$alternativeContactNo = mysqli_real_escape_string($dbc, trim($_POST['alternativeContactNo']));

$q = "UPDATE contact_person SET contactNo = '$contactNo', alternativeContactNo = '$alternativeContactNo' WHERE cpID = '$cpID'";
